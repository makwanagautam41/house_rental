    ...
    <div class="container mx-auto px-4 py-12">
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div>
                ...
                <ul class="space-y-2">
                    <li><a href="index.php" class="text-sm text-gray-500 hover:text-gray-900 transition-colors">Home</a></li>
                    <li><a href="properties.php" class="text-sm text-gray-500 hover:text-gray-900 transition-colors">Properties</a></li>
                    <li><a href="about.php" class="text-sm text-gray-500 hover:text-gray-900 transition-colors">About Us</a></li>
                    <li><a href="contact.php" class="text-sm text-gray-500 hover:text-gray-900 transition-colors">Contact</a></li>
                </ul>
            </div>
            ...
            <div>
                ...
                <ul class="space-y-2">
                    <li><a href="help.php" class="text-sm text-gray-500 hover:text-gray-900 transition-colors">Help Center</a></li>
                    <li><a href="privacy.php" class="text-sm text-gray-500 hover:text-gray-900 transition-colors">Privacy Policy</a></li>
                    <li><a href="terms.php" class="text-sm text-gray-500 hover:text-gray-900 transition-colors">Terms of Service</a></li>
                    <li><a href="faq.php" class="text-sm text-gray-500 hover:text-gray-900 transition-colors">FAQ</a></li>
                </ul>
            </div>
            ...
            <div>
                ...
                <ul class="space-y-3">
                    <li class="flex items-start gap-3">
                        ...
                        <span class="text-sm text-gray-500">123 Main St, Anytown, USA 12345</span>
                    </li>
                    ...
                    <li class="flex items-center gap-3">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="h-5 w-5 text-gray-500"><rect width="20" height="16" x="2" y="4" rx="2"></rect><path d="m22 7-8.97 5.7a1.94 1.94 0 0 1-2.06 0L2 7"></path></svg>
                        <span class="text-sm text-gray-500">support@homehaven.com</span>
                    </li>
                </ul>
            </div>
        </div>
        ...
        <div class="border-t border-gray-200 mt-8 pt-8 text-center">
            <p class="text-sm text-gray-500">
                &copy; <?php echo date("Y"); ?> HomeHaven. All Rights Reserved.
            </p>
        </div>
    </div>
</footer>
